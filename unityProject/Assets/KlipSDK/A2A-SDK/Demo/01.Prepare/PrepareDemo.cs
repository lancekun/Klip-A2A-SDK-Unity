...
{
    [SerializeField] private string ApplicationName = "Klip-A2A-SDK-Sample-01-Prepare";
    [SerializeField] private Text resultText;
    
    
    class AuthPrepareCallback : KlipCallback<KlipResponse>
    {
        private PrepareDemo prepareDemo;
        
        public AuthPrepareCallback(PrepareDemo demo)
        {
            prepareDemo = demo;
        }
